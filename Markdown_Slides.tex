...
\NormalTok{mtcars5 <-}\StringTok{ }\KeywordTok{filter}\NormalTok{(mtcars, gear }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{,}\DecValTok{6}\NormalTok{)) }\CommentTok{# =mtcars4}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Markdown_Slides_files/figure-beamer/unnamed-chunk-18-1.pdf}
...
\begin{center}\includegraphics{Markdown_Slides_files/figure-beamer/unnamed-chunk-19-1} \end{center}
...
\begin{center}\includegraphics{Markdown_Slides_files/figure-beamer/unnamed-chunk-20-1} \end{center}
...
\begin{center}\includegraphics{Markdown_Slides_files/figure-beamer/unnamed-chunk-21-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data1}\OperatorTok{$}\NormalTok{dummy <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(data1}\OperatorTok{$}\NormalTok{year1}\OperatorTok{>}\DecValTok{3012}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data4[}\KeywordTok{order}\NormalTok{(data4}\OperatorTok{$}\NormalTok{alpha),]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data4[}\KeywordTok{order}\NormalTok{(data4}\OperatorTok{$}\NormalTok{alpha, data4}\OperatorTok{$}\NormalTok{beta),]}
\end{Highlighting}
\end{Shaded}
